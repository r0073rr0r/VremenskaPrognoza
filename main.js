...
function vreme(grad) {
    ...
    request(url, function (error, response, body) {
        if (!error) {
            ...
            //console.log(data);
            console.log("Grad: " + data.name + " - Temperatura: " + data.main.temp + "°C - Pritisak: " + data.main.pressure + " - Temp.min: " + data.main.temp_min + "°C - Temp.max: " + data.main.temp_max + "°C - Brzina vetra: " + data.wind.speed + "m/s - Koordinate: " + data.coord.lon + "," + data.coord.lat + "");
        } else {
